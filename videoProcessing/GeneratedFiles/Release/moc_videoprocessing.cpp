...
struct qt_meta_stringdata_videoProcessing_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_videoProcessing_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_videoProcessing_t qt_meta_stringdata_videoProcessing = {
    {
QT_MOC_LITERAL(0, 0, 15) // "videoProcessing"
...
const QMetaObject videoProcessing::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_videoProcessing.data,
      qt_meta_data_videoProcessing,  qt_static_metacall, nullptr, nullptr}
};
...
void *videoProcessing::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_videoProcessing.stringdata0))
